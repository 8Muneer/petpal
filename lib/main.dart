...
Future<void> main() async {
  ...
  // Edge-to-edge: the app draws behind the system nav bar and the bar
  // itself is transparent, so it blends into the app's UI instead of
  // showing a solid black strip.
